...
class ours4_realmore22(torch.nn.Module):
    r"""
    ...
    def __init__(self, config, dataset, args):
        super(ours4_realmore22, self).__init__()
    ...
    def forward(self, item_seq, item_seq_len, beha_seq):
        ...
        for i, name in enumerate(self.selected_features):
            if i==0:
                ...
                fea_hidden = self.decoder2(output, feature_table[i].squeeze(), beha_emb, extended_attention_mask)

...
#1 means 0.5 for boost2

class ours1(torch.nn.Module):
    r"""
    ...
    def __init__(self, config, dataset, args):
        ...
        self.boost2 = torch.nn.Parameter(torch.ones((self.p_heads, 1, 1), requires_grad=True)*0.5)
    ...
    def calculate_loss(self, interaction):
        ...
        return itemloss+ self.weight_norm*(self.boost1.norm()+self.boost2.norm())

...
#attributes is used in weight
class ours4_realmore2aw(torch.nn.Module):
    r"""
    ...
    def __init__(self, config, dataset, args):
        super(ours4_realmore2aw, self).__init__()
    ...
    def calculate_loss(self, interaction):
        ...
        # itemoutput squeezed
        itemoutput = self.forward(item_seq, item_seq_len, beha_seq)
        args = self.args
        ...
        final_output = self.new_fwd_layer(itemoutput).squeeze()

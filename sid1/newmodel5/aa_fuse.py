...
class aa_fuse(torch.nn.Module):
    ...
    def concat(self, item_logits, fea_logits):
        fea_input= torch.cat(fea_logits, dim=-1).squeeze()
    ...
    def calculate_loss(self, interaction):
        ...
        for i, name in enumerate(self.selected_features):
            ...
            feature_table.append(fea_result)
        ...
        if self.args.integra =='concat':
            allinput = self.concat(catetest_item_emb, feature_emb)

...
#ours
    ...
    trainer = pl.Trainer(devices=[0], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./script1/side1/{}/hidden{}/lr{}/layer{}/head{}/{}/{}/norm{}/{}/head{}'.format(args.dataset+feature_num, config['hidden_size'],config['learning_rate'],  config['n_layers'], config['n_heads'],  args.model, args.integra, args.weight_norm, args.pooling_mode, args.p_heads), log_every_n_steps=log_steps)

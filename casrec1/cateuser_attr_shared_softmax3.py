...
class PASR(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        cate_input = self.starmodel(self.itemmodel.cateitem_emb(item_seq_batch), self.catemodel.item_emb(cate_seq_batch), cate_fuse , mask)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        catetest_item_emb = self.itemmodel.cateitem_emb.weight
        catelogits = torch.einsum('cd,bhd -> bhc',catetest_item_emb , cate_input)
...
if args.datasets=='taobao':
    trainer = pl.Trainer(devices=[args.cuda], callbacks=[modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./final/{}/cu_shared3/gamma{}/beam{}/recall{}/lr{}'.format(args.datasets, args.gamma, args.beam_size, args.recall, args.lr))
else:
    trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./final/{}/cu_shared3/gamma{}/beam{}/recall{}/lr{}'.format(args.datasets, args.gamma ,args.beam_size, args.recall, args.lr))

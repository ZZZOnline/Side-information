...
# else:
trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./ffinal/{}/newcasrecmul/{}/beam{}/gamma1{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.integra, args.beam_size, args.gamma1, args.gamma, args.recall, args.lr))

...
if args.datasets =='kuai':
    args.dataset = './data/kuai_10.csv'
    User = dataall_partition_last(args.dataset)
    args.batch_size = 128
    args.beam_size=10
    args.lr = 0.0001
...
if args.datasets =='kuai_pure':
    args.dataset = './data/kuai_pure.csv'
    User = dataall_partition_last(args.dataset)
    args.batch_size = 128
    args.beam_size=10
    args.lr = 0.001
...
if args.datasets=='taobao':
    trainer = pl.Trainer(devices=[args.cuda], callbacks=[modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=50,  default_root_dir='./final/{}/cu_allshared_gamma/gating/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets ,args.beam_size, args.gamma, args.recall, args.lr))
else:
    trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=100,  default_root_dir='./final/{}/cu_allshared_gamma/gating/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.beam_size, args.gamma, args.recall, args.lr))

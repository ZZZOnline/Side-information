...
class PASR(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        iteminput = self.itemmodel.cateitem_emb(item_seq_batch)+self.itemmodel.cate_emb(cate_seq_batch)
...
if args.datasets=='taobao':
    trainer = pl.Trainer(devices=[args.cuda], callbacks=[modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./final/{}/cu_shared6/beam{}/recall{}/lr{}'.format(args.datasets ,args.beam_size, args.recall, args.lr))
else:
    trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./final/{}/cu_shared6/gamma{}/beam{}/recall{}/lr{}'.format(args.datasets, args.gamma ,args.beam_size, args.recall, args.lr))

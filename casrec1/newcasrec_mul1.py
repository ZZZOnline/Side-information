...
class PASR(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        logits = torch.einsum('cd,bd -> bc', allinput , self.itemfeed(starinput.unsqueeze(1)).squeeze())
        ...
        catelogits = torch.einsum('cd, bd ->bc', cateallinput, self.catefeed(starinput.unsqueeze(1)).squeeze())
    ...
    def validation_step(self, batch, batch_idx):
        ...
        catelogits = torch.einsum('cd, bhd -> bhc', allinput  , self.itemfeed(cate_input).squeeze())
...
# else:
trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./ffinal/{}/newcasrecmul1norm/{}/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.integra, args.beam_size,  args.gamma, args.recall, args.lr))

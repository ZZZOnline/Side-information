...
# else:
trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./fffinal/{}/newcasrecmul2inte/{}/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.integra,  args.beam_size, args.gamma, args.recall, args.lr))

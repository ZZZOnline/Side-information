...
parser.add_argument('--gamma', default=25, type=float)

# parser.add_argument('--hidden_units', default=64, type=int)
parser.add_argument('--hidden_units', default=128, type=int)
parser.add_argument('--hidden_size', default=128, type=int)
parser.add_argument('--incatemaxlen', type=int, default=10)
parser.add_argument('--integra', default='gating', type=str)
...
#为int时， loss = args.gamma*floss + (1-args.gamma)*itemloss
#为int1时， loss = args.gamma*floss + itemloss
#只用cate训练时基于catey_seq_batch
# if args.datasets=='taobao':
#     trainer = pl.Trainer(devices=[args.cuda], callbacks=[modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=100,  default_root_dir='./final/{}/cu_allshared_int/{}/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.integra, args.beam_size, args.gamma, args.recall, args.lr))
# else:
trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=100,  default_root_dir='./ffinal/{}/newcasrecint/{}/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.integra, args.beam_size, args.gamma, args.recall, args.lr))

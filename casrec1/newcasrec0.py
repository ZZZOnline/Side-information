#embedding table and value matrix is both gated with categoroy and item compared to normal newcasrec! 
import torch
import numpy as np
...
# else:
trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=100,  default_root_dir='./ffinal/{}/newcasrec0/gating/beam{}/gamma{}/recall{}/lr{}'.format(args.datasets, args.beam_size, args.gamma, args.recall, args.lr))

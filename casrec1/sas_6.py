...
class casr(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        item_logits = self.itemmodel.log2feats_6(item_seq, cate_seq, mask)
...
trainer = pl.Trainer(devices=[args.cuda], callbacks=[early_stop_callback, modelcheckpoint], accelerator="gpu", accumulate_grad_batches=1, max_epochs=200,  default_root_dir='./final/{}/sas_6/recall{}/lr{}'.format(args.datasets , args.recall, args.lr))
